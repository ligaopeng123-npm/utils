    ...
    768 < document.documentElement.clientWidth || (localStorage.setItem(c, !1), (r = document.createElement("button")).classList.add("sidebar-pin"), r.onclick = l, document.body.append(r), window.addEventListener("load", function () {
        ...
        e.doneEach(function (e, n) {
            ...
            i(t), document.querySelectorAll(".sidebar-nav li").forEach(function (e) {
                ...
                e && e.childNodes && e.childNodes.forEach(function (e, index) {
                    e.classList && e.classList.contains("folder") && (e.classList.add("level-".concat(t)),
                    window.$docsify && window.$docsify.sidebarDisplayLevel && "number" == typeof window.$docsify.sidebarDisplayLevel && t <= window.$docsify.sidebarDisplayLevel && index < window.$docsify.sidebarDisplayOpenNumber && e.classList.add("open"),
