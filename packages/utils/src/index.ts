...
export {
    ...
    // 硬件判断
    isWindows, isMac, isLinux, isMobile, isAndroid, isIOS, isWX, isFlutter, getPlatform,
    // 版本获取
...
export {
    ...
    getMouseEnterDirection, getMouseEnterAngle, getDirectionByAngle,
    // 复制文本 数组 对象 字符串长度
...
export {
    ...
    retry, promiseScheduler, PromiseTasks, FreeTasks, AsyncToSync, sleep, addMethod, createOverload,
    hasOperate, off, on,
    easingFuncs, animate,
